...
export default function ContactLocatieBeheerPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (error) {
      ...
      setMelding({ type: 'success', text: 'Locatiegegevens opgeslagen.' })
    }
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 pt-6">
      <h1 className="text-xl font-bold text-gray-800 mb-6">Locatie beheren</h1>
