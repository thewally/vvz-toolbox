  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Teams kaartjes */}
        {[
          { label: 'Teams Senioren', to: '/teams/senioren', sub: 'Alle senioren teams' },
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-lg font-semibold text-gray-800 group-hover:text-vvz-green transition-colors">{label}</h3>
        ...
        >
          ...
          <div className="p-5">
            <h3 className="text-lg font-semibold text-gray-800 group-hover:text-vvz-green transition-colors">Plattegrond</h3>
            <p className="text-sm text-gray-500 mt-1">Overzicht van het complex en de veldindeling</p>
          </div>
        </Link>
        {/* Huistijl kaartje */}
        <Link
