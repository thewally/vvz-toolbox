    ...
    <div className="max-w-5xl mx-auto p-4 pt-6 space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          onClick={handlePrint}
          disabled={exporting}
          className="self-start sm:self-auto shrink-0 inline-flex items-center gap-2 bg-vvz-green text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-vvz-green/90 transition-colors disabled:opacity-50"
        >
